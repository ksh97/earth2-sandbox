        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.heroPanel}>
            ...
            <View style={styles.heroBadge}>
              <Text style={styles.heroBadgeText}>{formatProvider(forecast?.provider)}</Text>
            </View>
          </View>
          ...
          <View style={styles.forecastPanel}>
            ...
            {isLoading && !forecast ? (
              ...
              <Text style={styles.badge}>{formatProvider(forecast?.provider)}</Text>
            )}
          </View>
...
function formatProvider(provider?: ForecastSummary["provider"]) {
  return provider === "fourcastnet" ? "FourCastNet" : "Mock";
}
