...
MOCK_LEAD_HOURS = [0, 6, 12, 24, 36, 48, 72]
...
class MockForecastProvider:
    ...
    async def get_point_forecast(self, latitude: float, longitude: float) -> ForecastSummary:
        ...
        timeline = [
            ...
            for lead_time_hours in MOCK_LEAD_HOURS
        ]
        ...
        return ForecastSummary(
            ...
            forecast_window=ForecastWindow(
                ...
                end_at=generated_at + timedelta(hours=MOCK_LEAD_HOURS[-1]),
                step_hours=6,
                lead_hours=MOCK_LEAD_HOURS,
            ),
            timeline=timeline,
...
MockForecastService = MockForecastProvider
